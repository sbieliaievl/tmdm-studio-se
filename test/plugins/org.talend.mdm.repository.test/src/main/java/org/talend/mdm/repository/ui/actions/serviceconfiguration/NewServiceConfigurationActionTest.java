...
public class NewServiceConfigurationActionTest {
    ...
    public void testCreateServerObject() throws Exception {
        ...
        NewServiceConfigurationAction mockAction = mock(NewServiceConfigurationAction.class);
        ...
        Mockito.verify(mockAction).createItemAndSave(Mockito.any(WSServiceConfigurationItem.class), Mockito.anyString());
        System.out.println();
    }
