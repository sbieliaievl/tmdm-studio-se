...
public class ViewObjectPropertyMainSection extends AbstractPropertySection {

    IRepositoryViewObject obj;

    private ViewObjectPropertyMainComposite composite;

    public ViewObjectPropertyMainSection() {
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
        ...
        composite = new ViewObjectPropertyMainComposite(compTop, SWT.NULL);
    }
