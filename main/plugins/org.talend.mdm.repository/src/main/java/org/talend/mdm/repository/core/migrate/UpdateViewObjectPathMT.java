 ...
 */
public class UpdateViewObjectPathMT extends DefaultUpdateObjectPathMigrationTask {
     ...
     * @param handler
     */
    public UpdateViewObjectPathMT() {
        super(new MigrateObjectPathHandler(new ViewMigrateObjectPathRule()));
    }
