...
public class SimpleTypeTotalDigitsFacetPropSourceBuilder extends SimpleTypeFacetPropSourceBuilder {
    ...
    protected IPropertySource<?> doCreatePropSource(XSDSimpleTypeDefinition simpleType, Composite cellEditorParent,
        ...
        return new SimpleTypeFacetIntegerPropertySource(cellEditorParent, IConstants.SIMPLETYPE_FACETNAME_TOTALDIGITS,
                (Integer) sourceFacetValue);
    }

    @Override
    protected Object getSourceFacetValue(XSDSimpleTypeDefinition simpleType) {
        return SimpleTypeFacetValueExtractor.getIntFacetValue(simpleType.getTotalDigitsFacet());
    }
