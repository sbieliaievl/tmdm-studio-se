...
public class SimpleTypeMinLengthFacetPropSourceBuilder extends SimpleTypeFacetPropSourceBuilder {
    ...
    protected IPropertySource<?> doCreatePropSource(XSDSimpleTypeDefinition simpleType, Composite cellEditorParent,
        ...
        return new SimpleTypeFacetIntegerPropertySource(cellEditorParent, IConstants.SIMPLETYPE_FACETNAME_MINLENGTH,
                (Integer) sourceFacetValue);
    }

    @Override
    protected Object getSourceFacetValue(XSDSimpleTypeDefinition simpleType) {
        return SimpleTypeFacetValueExtractor.getIntFacetValue(simpleType.getMinLengthFacet());
    }
